	...
	public class TransaqDataManager implements Callback {
		...
		public boolean callback(String data) {
			...
			try {
		        ...
		        case "markets":
		        	JAXBContext contextMarkets = JAXBContext.newInstance(primus.broker.connector.transaq.Markets.class);
		        	Unmarshaller transformMarkets = contextMarkets.createUnmarshaller();
		        	primus.broker.connector.transaq.Markets markets = (primus.broker.connector.transaq.Markets)transformMarkets.unmarshal(element);
		        ...
		        case "server_status":
		        	JAXBContext contextServerStatus = JAXBContext.newInstance(primus.broker.connector.transaq.ServerStatus.class);
		        	Unmarshaller transformServerStatus = contextServerStatus.createUnmarshaller();
		        	primus.broker.connector.transaq.ServerStatus serverStatus = (primus.broker.connector.transaq.ServerStatus)transformServerStatus.unmarshal(element);
		        	Proxy.sendData(serverStatus);
		        	break;
		        	
		        case "securities":
		        	JAXBContext contextSecurities = JAXBContext.newInstance(primus.broker.connector.transaq.Securities.class);
		        	Unmarshaller transformSecurities = contextSecurities.createUnmarshaller();
		        	primus.broker.connector.transaq.Securities Securities = (primus.broker.connector.transaq.Securities)transformSecurities.unmarshal(element);
